...
from db.iPhone11_models import Comment
...
def get_all_comments_wordcloud():
    ...
    wordcloud.to_file(IMAGE_DIR + '/iPhone11_all_comments_wordcloud.png')
...
def get_after_comments_wordcloud():
    ...
    # 使用jieba分词的默认精确模式
    wordcloud.generate(' '.join(jieba.lcut(content)))
    wordcloud.to_file(IMAGE_DIR + '/iPhone11_after_comments_wordcloud.png')
...
def get_ios_comments_wordcloud():
    ...
    # 使用jieba分词的默认精确模式
    wordcloud.generate(' '.join(jieba.lcut(content)))
    wordcloud.to_file(IMAGE_DIR + '/iPhone11_ios_comments_wordcloud.png')
...
def get_android_comments_wordcloud():
    ...
    # 使用jieba分词的默认精确模式
    wordcloud.generate(' '.join(jieba.lcut(content)))
    wordcloud.to_file(IMAGE_DIR + '/iPhone11_android_comments_wordcloud.png')
...
def get_non_five_star_comments_wordcloud():
    ...
    # 使用jieba分词的默认精确模式
    wordcloud.generate(' '.join(jieba.lcut(content)))
    wordcloud.to_file(IMAGE_DIR + '/iPhone11_non_five_star_comments_wordcloud.png')
