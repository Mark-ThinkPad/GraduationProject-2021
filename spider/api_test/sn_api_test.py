...
def get_review_satisfy():
    response = requests.get(review_satisfy_url, headers=headers)
...
def get_review_labels():
    response = requests.get(review_labels_url, headers=headers)
...
def get_review_lists():
    response = requests.get(review_lists_url, headers=headers)
